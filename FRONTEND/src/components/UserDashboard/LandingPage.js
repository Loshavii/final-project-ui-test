...
//                  <button className="px-8 py-4 bg-green-500 text-gray-900 rounded-full font-semibold transform hover:scale-105 hover:bg-green-400 active:scale-95 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/25">
//                  Start Your Journey
//                  </button>
//                </div>
//              </div>
